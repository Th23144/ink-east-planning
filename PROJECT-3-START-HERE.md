...
- **Round 7 — SEALED / product architecture only.** Current truth: `docs/INK-EAST-ROUND-7-CURRENT-TRUTH-V1.md`, validated by `docs/ROUND-7-V1-SOURCE-PARITY-PASS.md` and `docs/ROUND-7-V1-ADVERSARIAL-AUDIT.md`, sealed by `docs/INK-EAST-ROUND-7-SEAL-RECORD.md`.
- **Current next workshop subject: Round 8 — Community & Discussion System / 社区与讨论系统.**
...
Round 7 now supplies the durable Knowledge Graph & Provenance baseline. It preserves, among other things:
...
The user-confirmed `Ink & East Ancient Books Image Rights & Source Policy v0.1` remains an operational rights/search-clearance policy input. The institution whitelist and A/B/C/D source classes are configurable operational policy, not permanent ontology. Round 7 explicitly preserves commercial-use clearance, `Item-level Rights > Collection-level Rights > Institution-level Policy`, original Rights wording/evidence, rights history/re-review, and the separation between reuse permission and technical access rules.

Round 8 Community & Discussion must build on these boundaries. It may link discussion precisely to canonical works/passages, knowledge entities and durable publications without turning discussion into canonical/source truth or allowing social popularity to rewrite provenance.
...
17. `docs/INK-EAST-PRODUCT-ARCHITECTURE-V1-WORKSHOP.md`
18. `docs/INK-EAST-PRODUCT-ARCHITECTURE-V1-DECISION-LOG.md`
19. historical Round 3/4 records when provenance is needed
20. PR #53 latest conversation/decision history while the workshop remains open
21. `INK-EAST-BRIEF.md` for product history while ignoring superseded assumptions
22. `docs/PROJECT-2-TO-PROJECT-3-ECOMMERCE-PARITY-MATRIX.md`
23. `docs/PROJECT-3-COMMERCE-BATCH-A-ACCEPTED.md`
24. `docs/PROJECT-3-CURRENT-HANDOFF.md`
25. superseded Round 6 Final/Seal and older planning documents only as historical references
